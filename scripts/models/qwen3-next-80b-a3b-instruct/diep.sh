#!/usr/bin/env bash
#
# DiEP -- Qwen3-Next-80B-A3B-Instruct
#
...
ep_run DiEP-damped-a0.25-cap0.9-kmin2-beta0.57 \
...
ep_run DiEP-damped-a0.25-cap0.9-kmin2-beta0.72 \
